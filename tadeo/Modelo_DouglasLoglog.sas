...
Title "Modelo Regresión Lineal Multiple"; 
Data Regresion Lineal Multiple;
...
/*Modelo con regresión lineal: comandos clm y cli*/
Title "Modelo Douglas con prediccion clm y cli"; 
Data Regresion;
Input Anio Prod Cap Sup Trab;
LProd= log(Prod); LCap=log(Cap); LSup= log(Sup); LTrab = log(Trab); 
;
...
1983      47674     1.4817     17343        8245
1984      48770     1.6516     17451        8300
1987        . 		1.7917		1.9434		8500 
;
proc glm;
model LProd= LCap LSup LTrab/ clm cli; 
options linesize =100 pagesize =300;
run;
quit;

/*Modelo con regresión lineal: comandos clm y cli*/
Title "Modelo Douglas con prediccion clm "; 
Data Regresion Lineal Multiple;
Input Anio Prod Cap Sup Trab;
Cards; 
1970      31515     0.8546     14975        5436
...
1983      47674     1.4817     17343        8245
1984      48770     1.6516     17451        8300
1987        . 		1.7917		19434		8500 
;
proc glm;
model Prod= Cap Sup Trab/ clm; 
options linesize =100 pagesize =300;
run;
quit;
...
/*Modelo con regresión lineal: comandos clm y cli*/
Title "Modelo Douglas con prediccion cli"; 
Data Regresion Lineal Multiple;
Input Anio Prod Cap Sup Trab;
Cards; 
1970      31515     0.8546     14975        5436
